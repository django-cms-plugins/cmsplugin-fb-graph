...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.send_create_signal('cmsplugin_fb_agenda', ['FBNewsPlugin'])
    ...
    models = {
        'cms.cmsplugin': {
            ...
            'creation_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 19, 0, 0)'}),
        ...
        'cmsplugin_fb_agenda.fbnewsplugin': {
